...
import com.melonsail.app.melonfriends.views.FeedItemUIComponent;
import com.melonsail.app.melonfriends.views.LinkEnabledTextView;
import com.melonsail.app.melonfriends.views.listener.TextLinkClickListenerImpl;
...
public class LstViewFeedAdapter extends BaseAdapter{
	...
	public LstViewFeedAdapter(Activity activity, int layoutResId, String snsName) {
		...
		feedArrayList.add(new FeedEntry());
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent)
	{
		...
		if (feedArrayList == null || feedArrayList.size() < 2) {
			...
			feedItemUIComponent.getTxv_FeedUser().setText("This is your first time sign in.\n" +
															"It will take a few seconds to load your feed.\n" +
